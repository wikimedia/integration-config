...
if [[ $PROJECT_NAME == "core" ]]; then
    ...
    # The THING_NAME (extensions/Foo, services/parsoid)
    cd /workspace/src/"${ZUUL_PROJECT#mediawiki/}"
fi
...
if [[ ! -f sonar-project.properties ]]; then
    ...
    mkdir -p resources includes languages src modules maintenance tests
    {
        ...
        echo "sonar.exclusions=extensions/**/*,mw-config/**/*,node_modules/**/*,services/**/*,vendor/**/*,skins/**/*,logs/**/*,cache/**/*,resources/lib/**/*"
