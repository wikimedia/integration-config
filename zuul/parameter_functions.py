...
dependencies = {
    ...
    'CampaignEvents': ['Translate', 'WikimediaCampaignEvents'],
    'Campaigns': ['EventLogging'],
    'Capiunto': ['Scribunto'],
    'CentralAuth': ['AbuseFilter', 'AntiSpoof', 'CheckUser', 'GlobalBlocking',
                    'SecurePoll'],
    'CentralNotice': ['EventLogging'],
    'Challenge': ['SocialProfile'],
    'Chart': ['JsonConfig'],
    'Checklists': ['VisualEditor'],
    'CheckUser': ['AbuseFilter', 'CentralAuth', 'FlaggedRevs',
                  'GlobalBlocking', 'GuidedTour', 'MobileFrontend',
                  'Renameuser', 'TorBlock'],
    ...
    'EditNotify': ['Echo'],
    'ElectronPdfService': ['Collection', 'FlaggedRevs'],
    ...
    'MetricsPlatform': ['EventStreamConfig'],
...
phan_dependencies = {
    ...
    'AbuseFilter': ['CheckUser', 'CentralAuth', 'Echo', 'Renameuser',
                    ...
                    'ConfirmEdit'],
    'AchievementBadges': ['BetaFeatures', 'CentralAuth', 'Echo',
    ...
    'Capiunto': ['Scribunto'],
    'CentralAuth': ['AbuseFilter', 'AntiSpoof', 'CheckUser', 'ConfirmEdit',
                    'Echo', 'EventLogging', 'GlobalBlocking', 'MassMessage',
                    'MobileFrontend', 'Renameuser', 'SecurePoll',
                    'TitleBlacklist'],
    'CentralNotice': ['CentralAuth', 'MobileFrontend', 'Translate', 'cldr',
                      'UserMerge'],
    'Challenge': ['Echo', 'SocialProfile'],
    'Chart': ['JsonConfig'],
    'CheckUser': ['AbuseFilter', 'CentralAuth', 'EventLogging', 'GuidedTour',
                  'Renameuser', 'FlaggedRevs', 'GlobalBlocking', 'TorBlock',
                  'UserMerge'],
    ...
    'LinkFilter': ['Comments', 'ConfirmEdit', 'Echo', 'RandomGameUnit',
                   'SocialProfile', 'SpamRegex'],
    ...
    'MobileFrontend': ['AbuseFilter', 'CentralAuth', 'Gadgets',
                       'LiquidThreads', 'PageImages', 'Wikibase',
                       'XAnalytics'],
    'MobileFrontendContentProvider': ['MobileFrontend'],
    'Monstranto': ['Scribunto'],
